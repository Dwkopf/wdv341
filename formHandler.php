...
//Model-Controller Area.  The PHP processing code goes in this area. 
	...
	if (isset($_POST["vehicle1"]))
		$inVehicle1 = $_POST["vehicle1"];
	if (isset($_POST["vehicle2"]))
		$inVehicle2 = $_POST["vehicle2"];
	$inCars = $_POST["cars"];
}
?>
<!DOCTYPE html>
...
<?php if (isset($_POST["gender"])) { ?>
	<p>Vehicle 1: <?php echo $inGender; ?></p><?php } ?>
<?php if (isset($_POST["vehicle1"])) { ?>
	<p>Vehicle 1: <?php echo $inVehicle1; ?></p><?php } ?>
<?php if (isset($_POST["vehicle2"])) { ?>
	<p>Vehicle 2: <?php echo $inCars; ?></p><?php } ?>
